...
from hr_agent.tools.rules.annual_leave import split_year_quota, calc_annual_leave
...
def _mock_today(monkeypatch, y, m, d):
    ...
    monkeypatch.setattr("hr_agent.tools.rules.annual_leave.date", FakeDate)


def _mock_tools(monkeypatch, info, balance):
    monkeypatch.setattr("hr_agent.tools.rules.annual_leave.get_employee_info",
                        lambda ctx: info)
    monkeypatch.setattr("hr_agent.tools.rules.annual_leave.get_leave_balance",
